...
export default function Home() {
  return (
    ...
    {/* value proposition section : what value we provide to the customers */}
    ...
    <section className="bg-slate-100 py-24">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 l:mx-0 
      lg:max-w-none lg:grid-cols-2 gap-y-16">
        <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
          ...
          <div className="text-lg leading-8">
            <p>"The case feels durable and I even got a compliment on the
        ...
        {/* second testimonial : second user review */}
        <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
          <div className="flex gap-0.5 mb-2">
            <Star className="h-5 w-5 fill-green-600 text-green-600"/>
            <Star className="h-5 w-5 fill-green-600 text-green-600"/>
